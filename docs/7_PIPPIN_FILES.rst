...
- ``D5yr_analysis.yml``: run the full cosmological analysis both on data and on the 10 simulations


Order of operations
-------------------

1) Look at the top of the three files ``D5yr_biascor.yml``, ``D5yr_sim_nominal.yml``, ``D5yr_analysis.yml`` and check the keys that require to be changes (marked with ``CHANGE``). Check also that the ``OUTPUT`` path is correct.
...
.. .. note:: Last modified: March 2024 by M. Vincenzi
