...
* ``DES-SN5YR_DES``: The SMP light curve dataset from DES 5YR
* ``DES-SN5YR_LOWZ``: The Low-Z survey DES calibrated light curve data
* ``DES-SN5YR_Foundation``: The Foundation survey DES calibrated light curve data
* ``DES-SN5YR_DES_DIFFIMG``: The DIFFIMG, with PSF forced photometry over the entire dataset
...
.. table:: ``HEAD`` file SNTYPE nomenclature

    +-------------------------------+--------------------------------------------------------+
    | SNTYPE                        | Description                                            |
    +===============================+========================================================+
    | 0                             | "NO_SPEC" (for the vast majority, no spectra obtained) |
    +-------------------------------+--------------------------------------------------------+
    | 1                             | "SNIa"                                                 |
    +-------------------------------+--------------------------------------------------------+
    | 101                           | "SNIa?"                                                |
    ...
    | 4                             | "SNIa-pec"                                             |
    +-------------------------------+--------------------------------------------------------+
    | 5                             | "SNI" (no H in spectrum, but cant distinguisn Ia vs Ib)|
    +-------------------------------+--------------------------------------------------------+
    | 20                            | "SNIIP"                                                |
    +-------------------------------+--------------------------------------------------------+
    | 21                            | "SNIIL"                                                |
